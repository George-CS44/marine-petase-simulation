...
def gen_enviromental_heatmap(T_vals, pH_vals, parmas): # Grid of temperature and pH values
    T_grid, pH_grid = np.meshgrid(T_vals, pH_vals)
    T_act = activity_vs_temperature(T_grid, parmas)
    pH_act = activity_vs_ph(pH_grid, parmas)
